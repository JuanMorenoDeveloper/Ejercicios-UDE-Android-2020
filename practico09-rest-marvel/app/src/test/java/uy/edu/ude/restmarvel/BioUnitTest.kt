...
class BioUnitTest {
    ...
    fun findQuoteById() {
        ...
        val url =
            URL(
//                """
//                https://gateway.marvel.com/v1/public/characters?nameStartsWith=Spider&ts=$timestamp&apikey=$apiKey&hash=$hash
//                """
                """
               https://gateway.marvel.com/v1/public/characters/1009664?ts=$timestamp&apikey=$apiKey&hash=$hash
            """
            )
